...
const ContestantMap = ({ className, data, xAccessor, label, contestantAge, contestantName }) => {
    const gradientId = useUniqueId("ContestantMap-gradient")
    ...
    return (
        <div className={classNames(className, "ContestantMap")} ref={ref}>
            ...
            <Chart dimensions={dimensions}>
                ...
                <image
                    className="ContestantMap__peter-head"
                    x={(xScale(28)) - 3}
