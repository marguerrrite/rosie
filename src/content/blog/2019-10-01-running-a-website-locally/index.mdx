...
The world is our oyster. Continue editing the index.html and styles.css files to adjust and style the content, or jump into scripts.js to start writing some JavaScript.